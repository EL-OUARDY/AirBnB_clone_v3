...
test_file_storage.py"
    ...
    def test_file_storage_class_docstring(self):
        ...
        condition = len(FileStorage.__doc__) >= 1
        self.assertTrue(condition, "FileStorage class needs a docstring")
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        # check if get method retrieve newly created object
        result = models.storage.get(State, obj.id)
        self.assertEqual(result, obj)

        # invalid ID
        result = models.storage.get("State", "Not_Found_ID")
        self.assertEqual(result, None)
        # invalid class
        result = models.storage.get("DUMB_CLASS", obj.id)
        self.assertEqual(result, None)
